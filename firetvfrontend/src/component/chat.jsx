...
export default function Chat() {
  ...
  <div style={{ maxWidth: 500, margin: '40px auto', padding: 16 }}>
      ...
      <div style={{ maxHeight: 300, overflowY: 'auto', marginBottom: 12, border: '1px solid #ccc', padding: 8, borderRadius: 6 }}>
        {messages.map((msg, idx) => (
          <div key={idx} style={{ textAlign: msg.self ? 'right' : 'left', margin: '4px 0' }}>
            <span style={{
      ...
      <form onSubmit={sendMessage} style={{ display: 'flex', gap: 8 }}>
        ...
        />
        <button type="submit" style={{ padding: '8px 16px', background: '#2d72d9', color: '#fff', border: 'none', borderRadius: 6 }}>
          Send
        </button>
      </form>
    </div>
